    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                throw new Error(msg || "Error al guardar proveedor")
            }
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="space-y-4">
                    <h3 className="text-sm font-medium border-b pb-2">Información Fiscal</h3>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="Proveedor S.A. de C.V." {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="Mi Proveedor" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                ...
                {/* Dirección */}
                <div className="space-y-4">
                    <h3 className="text-sm font-medium border-b pb-2">Dirección</h3>
                ...
                {/* Datos Bancarios */}
                <div className="space-y-4">
                    <h3 className="text-sm font-medium border-b pb-2">Datos Bancarios</h3>
